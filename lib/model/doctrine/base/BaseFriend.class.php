 ...
 * @method Friend setName()       Sets the current record's "name" value
 * @method Friend setSpeciality() Sets the current record's "speciality" value
 * @method Friend setAddress()    Sets the current record's "address" value
 * @method Friend setEmail()      Sets the current record's "email" value
 * 
 * @package    swbrasil
 * @subpackage model
